...
Download [MongoDB](https://www.mongodb.com/download-center/community), find the directory where the bin file is and link it to your Environment Variables under PATH.
